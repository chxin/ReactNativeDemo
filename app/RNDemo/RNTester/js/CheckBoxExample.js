  ...
  render() {
    return (
      <View>
        ...
        />
        <Text>{this.state.trueCheckBoxIsOn ? 'On' : 'Off'}</Text>
        <Text>{this.state.falseCheckBoxIsOn ? 'On' : 'Off'}</Text>
      </View>
    );
  }
}
...
class CheckBoxExample extends React.Component<{}, $FlowFixMeState> {
  render() {
    return (
      <View>
        <BasicCheckBoxExample />
        <DisabledCheckBoxExample />
        <EventCheckBoxExample />
      </View>
    )
  }
}
